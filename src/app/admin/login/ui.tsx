  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full rounded-lg bg-[#4D0000]/90 px-4 py-3 text-sm font-bold text-[#FFF9A7] shadow-sm transition-all hover:bg-[#3A0000] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#4D0000] focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed group relative overflow-hidden"
      >
        ...
        {loading && (
          <div className="absolute inset-0 flex items-center justify-center">
            <svg
              className="animate-spin h-5 w-5 text-[#FFF9A7]"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            >
