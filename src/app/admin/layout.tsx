...
const NAV_CLASSES =
  'block px-4 py-2 rounded-md transition-colors hover:bg-[#4D0000]/90 hover:text-[#FFF9A7]';
  ...
  return (
    <div className={`min-h-dvh bg-[#FDFBF7] ${beVietnamPro.className}`}>
      ...
      <div className="flex min-h-[calc(100vh-73px)]">
        {/* Sidebar */}
        <aside className="w-64 bg-[#4D0000]/90 text-[#FFF9A7] hidden md:block shrink-0 shadow-lg">
